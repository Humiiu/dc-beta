...
public class LaporanActivity extends AppCompatActivity {
    ...
    private void setupFilters() {
        ...
        spnKelas.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, kelasOptions));

        String[] jurusanOptions = {"Jurusan", "RPL", "TKJ", "BC", "DKV", "GD", "ANM"};
        spnJurusan.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, jurusanOptions));

        String[] statusOptions = {"Status", "Lunas", "Belum Lunas"};
        spnStatus.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, statusOptions));
    ...
    private void processData() {
        ...
        for (Siswa s : allSiswa) {
            ...
            if (matchesKelas && matchesJurusan) {
                ...
                boolean matchesStatus = selStatus.equals("Semua Status") || ls.getStatus().equals(selStatus);
