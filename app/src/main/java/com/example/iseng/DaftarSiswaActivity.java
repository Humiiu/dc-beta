...
public class DaftarSiswaActivity extends AppCompatActivity {
    ...
    private void setupFilters() {
        String[] kelasOptions = {"Semua Kelas", "10", "11" , "12"};
        ArrayAdapter<String> adapterKelas = new ArrayAdapter<>(this, 
                android.R.layout.simple_spinner_dropdown_item, kelasOptions);
        spnFilterKelas.setAdapter(adapterKelas);

        String[] jurusanOptions = {"Semua Jurusan", "RPL", "TKJ", "BC", "DKV", "GD", "ANM"};
        ArrayAdapter<String> adapterJurusan = new ArrayAdapter<>(this, 
                android.R.layout.simple_spinner_dropdown_item, jurusanOptions);
    ...
    private void applyFilter() {
        ...
        for (Siswa s : allSiswaList) {
            boolean matchesKelas = selectedKelas.equals("Semua Kelas") || s.getKelas().equals(selectedKelas);
            boolean matchesJurusan = selectedJurusan.equals("Semua Jurusan") || s.getJurusan().equals(selectedJurusan);
